...
setParticipantCount(1348); // Replace with your desired participant count


 
    function copyToClipboard() {
      const urlCodeElement = document.getElementById('urlCode');
      const textArea = document.createElement('textarea');
      textArea.value = urlCodeElement.textContent;
